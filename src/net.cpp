...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Mzansicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"mzansicoins.com", "82.196.0.212"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"mzansicointools.com", "testnet-seed.mzansicointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Mzansicoin is probably already running."), addrBind.ToString().c_str());
        else
